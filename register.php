    ...
    if(isset($_POST['submit'])){
        ...
        if($select_seller->rowCount()>0)
        {
            ...
            if($pass != $cpass){
                ...
                $insert_seller = $conn->prepare("INSERT INTO `users` (id, name, email,  password,
                image) VALUES(?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>kIMsHOp's Chicken - register page</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="home.php">home</a><i class="fas fa-caret-right"></i>register</span>
        </div>
    </div>
            ...
            <div class="flex">
                <div class="col">
                    ...
                    <div class="input_field">
                        ...
                        <input type="password" name="cpass" placeholder="enter your name" maxlength="50" required class="box">
                    </div>
                </div>
            </div>
            <div class="input_field">
