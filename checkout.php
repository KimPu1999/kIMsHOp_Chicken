...
<head>
    ...
    <title>kIMsHOp's Chicken - checkout page</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="home.php">home</a><i class="fas fa-caret-right"></i>checkout</span>
        </div>
    </div>
                ...
                <div class="flex">
                    <div class="box">
                        <div class="input-field">
                            ...
                            <input type="text" name="name" required maxlength="50" placeholder="Enter our name" class="input">
                        </div>
                        <div class="input-field">
                            <p>your number <span>*</span></p>
                            <input type="number" name="number" required maxlength="10" placeholder="Enter our number" class="input">
                        </div>
                        <div class="input-field">
                            <p>your email <span>*</span></p>
                            <input type="email" name="email" required maxlength="50" placeholder="Enter our email" class="input">
                        </div>
                        <div class="input-field">
                            <p>payment method <span>*</span></p>
                            <select name="method" class="input">
                                <option value="cash on delivery">cash on delivery</option>
                                <option value="credit or debit cart">credit or debit card</option>
                    ...
                    <div class="box">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="city" required maxlength="50" placeholder="e.g cityname" class="input">   
                        </div>
                        <div class="input-field">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="pin" required maxlength="6" min="0" placeholder="e.g 411027" class="input">   
                        </div>
                    </div>
                </div>
                <button type="submit" name="place_order" class="btn">Proceed Order</button>
            <!-- place_order -->
            </form>
                ...
                <div class="box-container">
                    ...
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <p class="price">Rs <?= $fetch_products['price']; ?> X <?= $fetch_cart['qty'];?></p></div>
                    </div>
                    <?php
                            }
                        }else{
