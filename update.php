    ...
    if(isset($_POST['submit']))
    {
        ...
        if(!empty($image)){
            if($image_size > 2000000){
                ...
                $success_msg[] = 'image update successfully';
            }
        }
...
<head>
    ...
    <title>kIMsHOp's Chicken - update profile page</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="home.php">home</a><i class="fas fa-caret-right"></i>update profile</span>
        </div>
    </div>
