...
<head>
    ...
    <title>kIMsHOp's Chicken - my cart page</title>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="home.php">home</a><i class="fas fa-caret-right"></i>cart</span>
        </div>
    </div>
    <div class="products">
        <div class="heading">
        ...
        <form action="" method="post" class="box <?php if($fetch_products['stock'] == 0){ echo 'disabled';} ; ?>">
            ...
            <?php } ?>
            <div class="content">
                <!-- <img src="image/reman.pnp" class="shap" alt=""> -->
                <h class="name"><?= $fetch_products['name']; ?></h3>
                <div class="flex-btn">
                ...
                <div class="flex-btn">
                    <p class="sub-total">sub total : <spa>Rs <?= $sub_total = ($fetch_cart['qty'] * $fetch_cart['price']); ?></span>
                    </p>
        ...
        <?php if($grand_total != 0){ ?>
            <div class="cart-total">
                <p>total amount payable: <spa> Rs <?= $grand_total; ?>/-</span></p>
                <div class="button">
